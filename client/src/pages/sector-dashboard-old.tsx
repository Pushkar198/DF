...
const sectorConfig = {
  healthcare: {
    ...
    subcategories: {
      medicines: ["Tablets", "Syrups", "Injections", "Topical", "Inhalers"],
      "test kits": [
        "Blood Tests",
        "Urine Tests",
        "Rapid Tests",
      ...
      "surgical supplies": ["Instruments", "Sutures", "Gloves", "Masks"],
      "patient care items": ["Bandages", "Catheters", "Wheelchairs", "Beds"],
    },
  },
  automobile: {
    name: "Automobile",
    ...
    subcategories: {
      ...
      accessories: ["Interior", "Exterior", "Electronics", "Comfort"],
      "service equipment": [
        "Tools",
  ...
  agriculture: {
    ...
    subcategories: {
      seeds: ["Cereal Seeds", "Cash Crop Seeds", "Oilseed", "Vegetable Seeds"],
      fertilizers: [
        "Nitrogen",
        "Phosphorus",
        "Potassium",
      ...
      "irrigation equipment": ["Pipes", "Sprinklers", "Drip Systems", "Pumps"],
    },
  },
};
...
export default function SectorDashboard() {
  ...
  const downloadReport = () => {
    ...
    const summary =
      `DemandCast AI - ${config.name} Sector Forecast Report\n` +
      `Region: ${selectedRegion}\n` +
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/20 to-background">
      ...
      <div className="professional-header py-8 mb-8">
        ...
        <div className="flex gap-4">
          ...
          <Select value={selectedRegion} onValueChange={setSelectedRegion}>
            ...
            <SelectContent className="max-h-60 overflow-y-auto">
              ...
              <SelectItem value="Kalyan-Dombivali">
                Kalyan-Dombivali, Maharashtra
              </SelectItem>
              <SelectItem value="Vasai-Virar">
              ...
              <SelectItem value="Hubli-Dharwad">
              ...
              <SelectItem value="Mira-Bhayandar">
              ...
              <SelectItem value="Saharanpur">
                Saharanpur, Uttar Pradesh
              </SelectItem>
              <SelectItem value="Gorakhpur">
